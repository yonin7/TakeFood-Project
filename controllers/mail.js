          ...
          <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
            <tr>
              <td align="center" style="padding:40px 0 30px 0;background:#007BFF;">
                <img src="https://i.postimg.cc/vZw4cVx8/logo-removebg-preview.png" alt="" width="300" style="height:auto;display:block;" />
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="padding:36px 30px 42px 30px;">
                <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                  <tr>
                    <td style="padding:0 0 36px 0;color:#153643;">
                      <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">${name}, Your Order Successfully Placed</h1>
                      <h4 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">Thank you for ordering from TakeBis</h4>                      
                      <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                      Your order id: ${order.order_id}
                      <br>
                      Number of meals: ${order.order.total_quantity}
                      <br>
                      Total cost: ${order.order.total_price}
                      <br>
                      Regards, TakeBis.</p>
                    </td>
                  </tr>
...
const resetPassword = (email, name, link) => {
  sgMail.send({
    to: email,
    from: 'sending974@gmail.com', //domain
    ...
    text: `That was easy!`,
    html:
      // </strong><p>Follow this <a href=' + link +>Link</a> to reset your passowrd.</p>
      // <p>If this request is not made by you kindly ignore this mail.</p>
      // <p>Regards, <strong>TakeBis</strong></p>',
      ` <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;background:#ffffff;">
      <tr>
        <td align="center" style="padding:0;">
          <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
                ...
                <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                  <tr>
                    <td style="padding:0 0 36px 0;color:#153643;">
                      ...
                      <h4 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">Your request to reset your password accepted</h4>                      
                      <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                      </strong><p>Follow this <a href=' + link +>Link</a> to reset your passowrd</p>
                      <br>
                      <p>If this request is not made by you kindly ignore this mail.</p>
